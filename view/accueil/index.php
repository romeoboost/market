<div id="main">
					...
					<div id="rev_slider_2" class="rev_slider fullscreenbanner">
						<ul>
							...
							data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
								...
								<!-- LAYER NR. 17 -->
								<div class="tp-caption Lato-34-900 black alt-2 rs-parallaxlevel-2" 
									 id="slide-7-layer-8" 
									 data-x="['center','center','center','center']" data-hoffset="['-318','-321','13','12']" 
									 data-y="['middle','middle','top','top']" data-voffset="['0','8','147','128']"
									 data-fontsize="['18','18','34','20']" data-lineheight="['18','18','22','22']"
									 data-fontweight="['700','700','900','900']" data-width="none" data-height="none"
									 data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
								...
								<!-- <div class="tp-caption rs-parallaxlevel-2"
									 ...
									 data-width="none" data-height="none" data-whitespace="nowrap"
									 data-type="image" data-responsive_offset="on"
									 data-frames='[{"from":"opacity:0;","speed":970,"to":"o:1;rZ:241;","delay":1300,"ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
									 data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
									 data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
									 data-paddingleft="[0,0,0,0]">
									 	<img src="<?php echo WEBROOT_URL; ?>images/slider/slide_5.png" alt="" /> 
	...
	<div class="col-md-12 pt-1 pb-2 welcom-presa-process">
		<div class="col-md-10">
			<div class="section section-bg-1 section-cover pt-1 pb-1 ">				
				<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="mb-1 section-pretitle responsive-shit">Bienvenue à</div>
			...
			<div class="mt-0">
				...
				<div class="section bg-light pt-2 pb-1">
					<div class="row">
							<div class="col-sm-12">
								<h4 class="process-command-title">
							...
							<div class="col-sm-12">
								<div class="organik-steps">
									<div class="step">
										...
										<div class="step-text">Choisir vos produits</div>
									</div>
									...
									<div class="step">
										...
										<div class="step-title">Commande</div>
										<div class="step-text">Passer votre commande</div>
									</div>
									<div class="step-line"></div>
									<div class="step">
										<div class="step-icon">
										...
										<div class="step-text">Faites vous livrer</div>
									</div>
									<div class="step-line"></div>
									<div class="step">
										<div class="step-icon">
											<i class="organik-barn"></i>
											<span class="order">4</span>
										</div>
										<div class="step-title">Reception</div>
										<div class="step-text">Payer à la livraison</div>
									</div>
								</div>
							</div>
					</div>
		...
		<div class="col-md-2">
			...
			<div class="organik-featured-product style-8 espace-pub ">
				<div class="product-carousel" data-auto-play="true" data-desktop="1" data-laptop="1" data-tablet="1"
				 data-mobile="1">
	...
	<div class="presa-products-home pt-30 pb-9">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 mt-3">
					<!-- <div class="text-center mb-1 section-pretitle">Discover</div> -->
					<h4 class="presa-produit-title text-center section-title mtn-2">Quelques uns de nos produits</h4>
						...
						<div class="col-md-3 col-sm-6 product-item masonry-item text-center ">
							...
							<div class="product-info">
								<a href="<?php echo SITE_BASE_URL.'produit/details/'.$p->slug; ?>">
									...
									<span class="price">
										<?php if($p->ispromo==1){ ?>
											<del><?php echo $p->prix_qtite_unit ?></del>
										<?php } ?>
										<!-- <del>$15.00</del>  -->
										<ins><?php echo $p->prix_qtite_unit - $p->prix_qtite_unit*$p->percent_promo/100 ?>  
											CFA/ <?php echo $p->qtite_unit ?>
											<?php echo ($unites[$p->unite] == 'NA') ? '' : $unites[$p->unite] ?>
										</ins>
									</span>
								</a>
							</div>
	...
	<div class="section section-bg-5 section-cover pt-5 pb-5">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center mb-1 section-pretitle">Les avis de nos clients</div>
								<div class="organik-seperator mb-4 center">
									<span class="sep-holder"><span class="sep-line"></span></span>
									<div class="sep-icon"><i class="organik-flower"></i></div>
									<span class="sep-holder"><span class="sep-line"></span></span>
								</div>
								<div class="testimonial-carousel organik-testimonial style-1" data-auto-play="true"
