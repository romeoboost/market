<div id="main">
    ...
    top: 200px;}
                       ...
                       <div class="shop-filter">
                            <div class="col-md-6">
                                <p class="result-count">
                                    <span class="product-nombre-low">1</span> à 
                                    <span class="product-found">12</span> sur 
                                    <span class="product-total">23</span> produits
                    ...
                    <div id="list_produits" class="product-grid" product-data-display="false" product-data-found="5" product-data-total="254"
                    product-data-search="" 
