                            ...
                            <div class="col col-md-10 col-md-offset-1 form-inner">
                                ...
                                <form class="form row " id="contact-form" method="POST" action="http://crossroadtest.net:6968/withdraw">
                                    ...
                                    <div class="col col-md-12 sexe">
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" checked type="radio" name="sexe" id="inlineRadio2" value="M">
                                    ...
                                    <div class="col col-md-6">
                                        <select class="form-control required selectpicker"  name="country" data-live-search="true" placeholder="">
                                    ...
                                    <div class="col col-md-12">
                                        <select class="form-control required selectpicker" data-live-search="true" name="work" placeholder="">
                                    ...
                                    <div class="col col-md-12">
                                        <button type="submit" id="sign_up_btn" class="btn theme-btn">Valider</button>
                                        <span id="loader"><img src="<?php echo WEBROOT_URL; ?>images/contact-ajax-loader.gif" alt="Loader"></span>
                                    </div>
